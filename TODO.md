...
### Info screens
- [ ] **Field intro screen** — first time accessing the Field, show an illustrated explainer of how it works; wire redirect in auth flow
- [ ] **Host responsibility screen** — wire to trigger on first "+" tap via `has_seen_host_intro` profile flag
